...
- [x] T006 [P] Define all game constants from data-model.md constants table (GAME_WIDTH=360, GAME_HEIGHT=640, BIRD_X=80, BIRD_SIZE=32, BIRD_HITBOX_SHRINK=0.8, GRAVITY=0.0015, FLAP_IMPULSE=-0.45, HOVER_DECEL=-0.0013, MAX_FALL_SPEED=0.6, SCROLL_SPEED=0.15, GAP_HEIGHT=140, OBSTACLE_WIDTH=52, MIN_OBSTACLE_SPACING=200, MIN_GAP_MARGIN=80, COIN_RADIUS=12, PHYSICS_TIMESTEP=16.667, MAX_FRAME_DELTA=250, MAX_PHYSICS_STEPS=5, CALIBRATION_DURATION=1500, VOLUME_SMOOTHING=0.3) in src/models/constants.ts
